...
###In this chunk, I generate document term matrix and use LDA method to do topic modeling. Illustrate 15 topics and topic terms.
###In this case, k=15, means 15 topics.
...
###In this part, I continue to process data and cluster the most used terms into 5 group 
```{r}
...
###In this chunk, I plot the word count of every inauguration.
...
```
The most emotionally charged sentences
